...
import com.georgeinfo.rapidmvc.FrontServlet;
...
/**
 * 前置处理器(总入口，它跟RapidFilter二选一即可)
 * @author George <Georgeinfo@163.com>
 */
@WebServlet(name = "RapidServlet", urlPatterns = {"/api/*", "/home/*"})
public class RapidServlet extends FrontServlet {
